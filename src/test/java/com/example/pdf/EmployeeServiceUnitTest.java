...
import com.example.pdf.model.Employee;
import com.example.pdf.model.Role;
import com.example.pdf.service.EmployeeService;
...
//        .expectNextMatches(employee -> employee.getAge().equals(32))
  ...
  void updateEmployee() throws Exception {
    ...
    StepVerifier.create(updatedEmploye)
        .expectNextMatches(
            employee -> employee.getLastName().equals(newLastName) && employee.getAge() == newAge)
        .verifyComplete();
